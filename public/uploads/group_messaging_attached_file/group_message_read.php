...
<div class="ad flex fh qq fe ws wl wc translate-x" :class="profileSidebarOpen ? 'translate-x-1/3' : 'translate-x-0'">
            ...
            <div class="flex items-center">
                ...
                <div class="group_info">
                    <div x-data="{ modalOpen: false }">
                       ...
                       Miembros del grupo</button>
                       
                       <!-- Modal backdrop -->
                       <div class="th tm pb nm wi" x-show="modalOpen" x-transition:enter="wr wh wf" x-transition:enter-start="opacity-0" x-transition:enter-end="bv" x-transition:leave="wr wh wa" x-transition:leave-start="bv" x-transition:leave-end="opacity-0" aria-hidden="true" style="display: none;"></div>
                       <!-- Modal dialog -->
                          ...
                          <div class="bg-white rounded by lj aa oq ok" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                             ...
                             <div class="mn vm cx border-slate-200">
                                <div class="flex fg items-center">
                                   <div class="g_ text-slate-800"><?php echo ucfirst($this->db->get_where('group_message_thread', array('group_message_thread_code' => $current_message_thread_code))->row()->group_name);?></div>
                                   ...
                                   <div>
                                       <table  class="av oq lg lb" >
                                        <thead class="gb g_ gq text-slate-500 hq ck cx border-slate-200">
                                            <tr>
                                                <th class="v_ wk xe vm co"><?= ('Miembros'); ?></th>
    ...
    <div class="tv ty">
        <div class="flex items-center fg bg-white ck border-slate-200 vd jd zx op">
            <?php echo form_open(base_url() . 'admin/group/send_reply/' . $current_message_thread_code, array('enctype' =>
