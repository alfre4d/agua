<main>
    ...
    if ($var != '') {
        $admon = $this->db->query("SELECT * FROM admin WHERE type=1 AND first_name like '%" . $var . "%' OR last_name like '%" . $var . "%'")->result_array();
        if ($admon == false) {
            echo '';
        }
    } else {
        //$admins = $this->crud-> get_admin($this->session->userdata('name'));
    }
    //print_r($admins);
    ?>
    <?php endif;?>
        ...
        <div class="_y js jn ry">
            <div class="rw _a">
                <?php if (empty($admon)) {
                    ...
                    echo '<h1 class="gg zj text-slate-800 font-bold">Administradores registrados</h1>';
                }
                ?>
            ...
            <div class="sq fa _j fm ji fy">
                ...
                <a class="btn hb xs yo" href="<?php echo base_url() ?>admin/admins">Limpiar</a>
                <a href="<?php echo base_url(); ?>admin/create_admin">
                            ...
                            <div class="ad vl">
                                <div class="td">
                                    ...
                                    if ($row['status'] == 'Inactivo') {
                                        $mensaje = "Inactivo";
                                        $color = "#FF0000";
                                        echo "<p><font color='" . $color . "'>" . $mensaje . "</font></p>";
                                    } else {
                                        $mensaje = "Activo";
                                        $color = "#86D47B"; 
                                        echo "<p><font color='" . $color . "'>" . $mensaje . "</font></p>";
                                            ...
                                            <div x-data="{ modalOpen: false }">
                                                ...
                                                <ul>
                                                    ...
                                                    <?php if ($row['status'] == 'Activo') { ?>
                                                        <li><a class="gk text-sm yl xb flex mt me" href="#0" @click="open = false" @focus="open = true" @focusout="open = false" onclick="eliminarAdmon('<?php echo $id ?>');cambiarColor('el_div');">Eliminar/Desactivar</a></li>
                                                    <?php } ?>
                                                    <?php if ($row['status'] == 'Inactivo') { ?>
                                                        <li><a style="color: #86d47b ;" class="gk text-sm ys xy flex mt me" href="<?php echo base_url("admin/active_admins/" . $id); ?>" @click="open = false" @focus="open = true" @focusout="open = false">Re-activar</a></li>
                                                    <?php } ?>
                                                </ul>
                                                <!-- Modal backdrop -->
                                                    ...
                                                    <div class="bg-white rounded by lj aa oq ok" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                                        ...
                                                        <div class="mn vm cx border-slate-200">
                                                            <div class="flex fg items-center">
                                                                <div class="g_ text-slate-800">Actualizar administrador 🙌</div>
                                                        ...
                                                        <div class="mn mr">
                                                            <?php
                                                            $url = "admin/updateAdmin_post/" . $row['admin_id'] . "/" . $row['photography'];
                                                            ?>
                                                            <form action="<?php echo base_url($url) ?>" method="POST" enctype="multipart/form-data">
                                                                <div class="ls">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <img class="rounded-full" src="<?php echo base_url(); ?>public/uploads/img_admins/<?php echo $row['photography'] ?>" width="64" height="64" alt="User 01" />
                                                                    </div>
                                                                    <div>
                                ...
                                <header>
                                    <div class="flex justify-center in">
                                        <a class="td inline-flex fd" href="#0">
                                            ...
                                            <img class="rounded-full" src="<?php echo base_url(); ?>public/uploads/img_photography/<?php echo $row['photography'] ?>" width="64" height="64" alt="User 01" />
                                        </a>
                                    </div>
                                    <div class="gp">
                                    ...
                                    <div class="flex justify-center items-center">
                                        <span class="text-sm gk yu sw mr-1">-&gt;</span> <span><?php echo $row['phone'] ?></span>
                                    </div>
                                </header>
                                <div class="gp i_">
                                                ...
                                                <div class="ls">
                                                    <div class="_y jn ln ju jl ig">
                                                        <div class="_xx">
                                                            ...
                                                            <input type="hidden" name="reciever" value="admin-<?php echo $row['admin_id'];?>">
