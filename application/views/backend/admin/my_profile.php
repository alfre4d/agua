      ...
      <div class="bg-white by rounded-sm ry">
         <div class="flex fh zt qo">
            ...
            <?php 
               ...
               $admin = $this->crud->get_contador($this->session->userdata('login_user_id'));
               //print_r($contador);
            ?>
            <?php foreach($admin as $cont):?> 
            <div class="ad"><!-- Mostrar form -->
            <?php 
                $url = "admin/profileUpdateAdmin/".$cont['admin_id'];
            ?>
            <form action="<?php echo base_url($url)?>" method="POST" enctype="multipart/form-data" class="formulario" id="formulario">
               <!-- Panel body -->
               <div class="vs fz">
                  <h2 class="gg text-slate-800 font-bold id">Mi perfil administrador</h2>
                  ...
                  <section>
                     <div class="flex items-center">
                        ...
                        <div class="mr-4">
                           <img class="uy os rounded-full" src="<?php echo $this->crud->obtenerFoto();?>" alt="User upload" width="80" height="80">
                        </div>
                        <div class="container">
                  ...
                  <h3 class="gy yt text-slate-800 font-bold rx">Usuario</h3>
                     <div class="_y jn ln ju jl ig">
                        ...
                        <div class="_xx">
                           ...
                           <input name="role" id="disabled" disabled="disabled" class="tn oq kf kl kh ka" type="text" value="<?php echo $cont['role']?>" >
                        </div>
                        <div class="_xx">
                           <label class="block text-sm gk rx" for="location">DNI</label>
                           <input name="doc_dni" id="disabled" disabled="disabled" class="tn oq kf kl kh ka" type="text" value="<?php echo $cont['doc_dni']?>">
                        </div>              
                     </div>
                  ...
                  <h2 class="lower_messages">Precione el botón para modificar la contraseña</h2>  
                     <div class="rt uh">
                        <!-- Start -->
                           ...
                           <div class="text-sm yu gz r_" x-text="checked ? '' : 'Activar'"></div>
                        </div>
                        <!-- End -->
                     </div>
                  <!-- Password -->
               ...
               <footer>
                  <div class="flex fh vw vx ck border-slate-200">
                     <div class="flex lk">
                        <a href="<?php echo base_url()?>admin/panel" class="btn border-slate-200 hover--border-slate-300 ys" >Cancelar</a>
