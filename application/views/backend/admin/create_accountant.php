         ...
         <div class="flex fh zt qo">
            ...
            <div class="ad">
               ...
               <div class="vs fz">
                  ...
                  <h2 class="gg text-slate-800 font-bold id">Agregar nuevo contador ✨</h2>
                  <form action="<?php echo base_url(); ?>admin/insert_accountant" method="POST" class="formulario" id="formulario" enctype="multipart/form-data">
                     ...
                     <section>
                        ...
                        <div class="_y jn ln ju jl ig">
                           ...
                           <div class="_xx">
                              ...
                              <input id="date_of_birth" name="date_of_birth" class="tn oq" type="date" required max="2005-01-01">
                           </div>
                           <div class="_xx">
                     ...
                     <section>
                        <div class="_y jn ln ju jl ig">
                           ...
                           <div class="_xx" id="grupo__password">
                              ...
                              <p class="formulario__input-error">La contraseña tiene que ser de 6 a 8 dígitos</p>
                           </div>
