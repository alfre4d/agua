   ...
   <div class="vd jd tto vv oq ar ri">
      ...
      <div class="bg-white by rounded-sm ry">
         <div class="flex fh zt qo">
            ...
            <!-- Panel -->
            <?php
            $contador = $this->crud->get_contador($this->session->userdata('name'));
            //print_r($contador);
            ?>
            <div class="ad">
               <!-- Mostrar form -->
               ...
               <div class="vs fz">
                  ...
                  <h2 class="gg text-slate-800 font-bold id">Agregar nuevo administrador ✨</h2>
                  ...
                  <?php endif; ?>
                  <form action="<?php echo base_url(); ?>admin/insert_admin" method="POST" class="formulario" id="formulario" enctype="multipart/form-data">
                     ...
                     <section>
                        ...
                        <div class="_y jn ln ju jl ig">
                           ...
                           <div class="_xx">
                              ...
                              <input id="first_name" name="first_name" class="tn oq" type="text" required="" placeholder="">
                           </div>
                           <div class="_xx">
                              <label class="block text-sm gk rx" for="business-id">Apellido Paterno <span class="yl">*</span></label>
                              <input id="last_name" name="last_name" class="tn oq" type="text" required="" placeholder="">
                           </div>
                           <div class="_xx">
                              <label class="block text-sm gk rx" for="business-id">Apellido Materno<span class="yl">*</span></label>
                              <input id="last_name_mom" name="last_name_mom" class="tn oq" type="text" required="" placeholder="">
                           </div>
                        </div>
                        ...
                        <div class="_y jn ln ju jl ig">
                           <div class="_xx">
                              ...
                              <input id="date_of_birth" min="1" name="date_of_birth" class="tn oq" max="2004-01-01" type="date" required>
                           </div>
                           <div class="_xx">
                     ...
                     <section>
                        <div class="_y jn ln ju jl ig">
                           <div class="_xx">
                              <label> Agregar fotografía<span class="yl">*</span></label>
                     ...
                     <section>
                        <div class="_y jn ln ju jl ig">
                           <div class="_xx" id="grupo__password">
                              <label class="block text-sm gk rx" for="password">Contraseña <span class="yl">*</span></label>
                              <div class="formulario__grupo-input">
                                 <input id="password" name="password" minlength="6" class="tn oq" type="password" required>
                           ...
                           <div class="_xx" id="grupo__password2">
                              <label class="block text-sm gk rx" for="password2">Repite contraseña <span class="yl">*</span> </label>
                              <div class="formulario__grupo-input">
                                 <input id="password2" name="password2" minlength="6" class="tn oq" type="password" required>
                                 <i class="formulario__validacion-estado fas fa-times-circle"></i>
                              </div>
                     ...
                     <footer>
                        <div class="flex fh vw vx ck border-slate-200">
                           <div class="flex lk">
                              <a href="<?php echo base_url() ?>admin/admins" class="btn border-slate-200 hover--border-slate-300 ys">Cancelar</a>
                              <button type="submit" class="btn hb xs yo ml-3" onClick="comprobarClave()">Guardar</button>
                           </div>
                        </div>
                     </footer>
                  </form>
