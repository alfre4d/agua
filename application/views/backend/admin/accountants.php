<main>
     <?php
               ...
               if($var != ''){
                    $account = $this->db->query("SELECT * FROM admin WHERE type=2 AND first_name like '%" . $var . "%' OR last_name like '%" . $var . "%'")->result_array();
                    if($account==false){
                         echo '';
                    }
               }
     ...
     <div class="vd jd tto vv oq ar ri">
          ...
          <div class="_y js jn ry">
               ...
               <div class="rw _a">
                   ...
                   if(!empty($account))
                   {
                       echo '<h1 class="gg zj text-slate-800 font-bold">Contadores registrados ✨</h1>';
                   }
         ...
         <?php endif;?>
               ...
               <div class="sq fa _j fm ji fy">
                    ...
                    <a class="btn hb xs yo" href="<?php echo base_url()?>admin/accountants" >Limpiar</a>
                    <a href="<?php echo base_url();?>admin/create_accountant">
                                        ...
                                        <ul>
                                             ...
                                             <ul>
                                                  ...
                                                  <?php if($row['status']=='Inactivo'){ ?>
                                                       <li id="reactivar" ><a class="gk text-sm ysp xbp flex mt me" href="<?php echo base_url("admin/active_account/".base64_encode($id));?>" @click="open = false" @focus="open = true" @focusout="open = false">Re-activar</a></li>
                                                  <?php }?>
                                            ...
                                            <div class="bg-white rounded by lj aa oq ok" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                                ...
                                                <div class="mn vm cx border-slate-200">
                                                    <div class="flex fg items-center">
                                                        <div class="g_ text-slate-800">Actualizar contador 🙌</div>
                                                ...
                                                <div class="mn mr">
                                                    <?php
                                                        $url = "admin/updateAccount/".$row['admin_id']."/".$row['photography'];
                                                        ?>
                                                ...
                                                <div class="ls">
                                                    <div class="_y jn ln ju jl ig">
                                                        <div class="_xx">
                                                            ...
                                                            <input type="hidden" name="reciever" value="accountant-<?php echo $row['admin_id'];?>">
