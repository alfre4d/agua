<main>
   <div class="vd jd tto vv oq ar ri">
      <div class="td py va jp rounded-sm lq ry">
         ...
         <div class="td">
            <h1 class="gg zj text-slate-800 font-bold rx">Hola, <?php echo $this->session->userdata('login_type');?> 👋</h1>
            <p>Bienvenido a su panel de administración...</p>
         </div>
      </div>
      ...
      <div class="sq ff fb">
         <div class="flex fh nk _s ttk bg-white by rounded-sm border border-slate-200">
            <div class="mn gn">
               <header class="flex fg fd in">
                  <img src="<?php echo base_url();?>public/uploads/images/icon-01.svg" width="32" height="32" alt="Icon 01"> 
                  <div class="td inline-flex" x-data="{ open: false }">
         ...
         <div class="flex fh nk _s ttk bg-white by rounded-sm border border-slate-200">
            <div class="mn gn">
               <header class="flex fg fd in">
                  <img src="<?php echo base_url();?>public/uploads/images/icon-02.svg" width="32" height="32" alt="Icon 02"> 
                  <div class="td inline-flex" x-data="{ open: false }">
                     <button class="yu xm rounded-full" :class="{ 'hy text-slate-500': open }" aria-haspopup="true" @click.prevent="open = !open" :aria-expanded="open">
                        <span class="tc">Menu</span> 
                        <svg class="uu of db" viewBox="0 0 32 32">
         ...
         <div class="flex fh nk _s ttk bg-white by rounded-sm border border-slate-200">
            <div class="mn gn">
               <header class="flex fg fd in">
                  <img src="<?php echo base_url();?>public/uploads/images/icon-03.svg" width="32" height="32" alt="Icon 03"> 
                  <div class="td inline-flex" x-data="{ open: false }">
                     <button class="yu xm rounded-full" :class="{ 'hy text-slate-500': open }" aria-haspopup="true" @click.prevent="open = !open" :aria-expanded="open">
                        <span class="tc">Menu</span> 
                        <svg class="uu of db" viewBox="0 0 32 32">
