<main>
         ...
         <div class="sq fa _j fm ji fy">
            ...
            <div class="table-items-action hidden">
               <div class="flex items-center">
                  ...
                  <button id="btndelete" class="btn bg-white border-slate-200 hover--border-slate-300 yl xb">Eliminar</button>
               </div>
            </div>
            <!-- Dropdown -->
   ...
   <?php }?>
   <?php if($clts['end_date'] != ''){ ?>   
      <button @click.prevent="modalOpen = true" aria-controls="feedback-modal" disabled="true" style="color: #9e9e9e;">
   <?php }?>      
      <span class="tc">Edit</span> 
...
<script type="text/javascript">
    $(document).ready(function(){
     $("#btndelete").on("click", function(){
           var bool=confirm("¿Estas seguro de eliminar las solicitudes?");
            if(bool){
         ...
         checks.forEach((e)=>{
             if(e.checked==true){
                 ...
                 $.ajax({
                 data: parametros,
                 url: '<?php echo base_url('Admin/delete_all_requests');?>',
                 type: 'POST',
...
function eliminarClient(id) {
    Swal.fire({
        title: "¿Estás seguro?",
        text: "Se eliminará toda la información de la solicitud",
        icon: "question",
        iconColor: "red",
        ...
        if (result.value) {
            ...
            location.href = "<?php echo base_url('/admin/delete_request')?>/" + id;
        }
    });
}
