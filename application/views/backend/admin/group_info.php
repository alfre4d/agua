<?php
$group_info = $this->db->get_where('group_message_thread', array('group_message_thread_code' => $param2))->result_array();
$user_info  = json_decode($group_info['members']);
?>
<div class="modal-body" style="margin-top:0px;">
    <div class="modal-header" style="background-color:#00579;">
        <h6 class="title" style="color:white"><?php echo ('Información del grupo'); ?></h6>
    </div>
        ...
        <div class="row">
            <div class="col-md-12" style="margin-top: 10px;">
                <table class="table table-bordered">
                    ...
                    ?>
                        <tr>
                            <td><img src="<?php echo $this->crud->obtenerFotoAdmim($user_type, $user_id); ?>" class="img-circle" width="30"></td>
