...
<div class="ad flex fh qq fe ws wl wc translate-x" :class="profileSidebarOpen ? 'translate-x-1/3' : 'translate-x-0'">
                                ...
                                <?php if($row['message'] != '' && $row['file_name'] != '' ):?>
                                    ...
                                    ?>
                                        <?php if($extension == 'pdf' ||$extension == 'docx'):?>
                                            ...
                                            <ul>
                                                <li><a target="_blank" class="bu" href="<?php echo base_url();?>public/uploads/archive/<?php echo $row['file_name'];?>"><?php echo $row['file_name']; ?></a></li>
    ...
    <div class="tv ty">
        <div class="flex items-center fg bg-white ck border-slate-200 vd jd zx op">
            <?php echo form_open(base_url() . 'admin/message/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data', 'class' => 'ad flex')); ?>
                        ...
                        <?php if($files->num_rows() > 0):?>
                            <ul>
                                ...
                                ?>
                                    <?php if($extension == 'pdf' || $extension == 'docx'):?>
                                    <li>
                                        <a class="text-sm gk text-indigo-500 xd" target="_blank" href="<?php echo base_url();?>public/uploads/archive/<?php echo $file['file_name'];?>" download="<?php echo $file['file_name'];?>">
