...
<main>
   <div class="vd jd tto vv oq ar ri">
      ...
      <div class="_y js jn ry">
         <!-- Left: Title -->
         <div class="rw _a">
            <h1 class="gg zj text-slate-800 font-bold">Gestionar contadores ✨</h1>
         </div>
         <!-- Right: Actions -->
         <div class="sq fa _j fm ji fy">
            <form class="td" method="POST">
               <label for="action-search" class="tc">Search</label> <input id="action-search" name="action-search" class="tn mf kn" type="text" placeholder="Search…"> 
            ...
            <a class="btn hb xs yo" href="<?php echo base_url()?>accountant/accountants" >Limpiar</a>
         </div>
      </div>
      ...
      ?>
        <?php if(empty($conta)):?>
               <div class="nk _s ttjjs bg-white by rounded-sm border border-slate-200">
                  ...
                  <header>
                     <div class="flex justify-center in">
                        <a class="td inline-flex fd" href="#0">
                           ...
                           <img class="rounded-full" src="<?php echo base_url();?>public/uploads/img_profile/<?php echo $cont['photography']?>" alt="User 01" width="64" height="64"> 
                        </a>
                     </div>
                     <div class="gp">
                        <a class="inline-flex text-slate-800 xk" href="#0">
                           <h2 class="gy yt justify-center g_"><?php echo $cont['first_name'].' '.$cont['last_name']?></h2>
                        </a>
                     </div>
                     <div class="flex justify-center items-center"><span class="text-sm gk yu sw mr-1">-&gt;</span><?php echo $cont['phone']?><span></span></div>
                  </header>
                  <div class="gp i_">
                     <div class="text-sm"><?php echo $cont['email']?></div>
                     <div class="text-sm"><?php echo $cont['doc_dni']?></div>
                     <div class="text-sm"><?php echo $cont['address']?></div>
                  </div>
               </div>
               <div class="ck border-slate-200">
                  <!---<a class="block gp text-sm text-indigo-500 xd gk me mr" href="messages.html">
                                        ...
                                        <div class="ls">
                                            <div class="_y jn ln ju jl ig">
                                                <div class="_xx">
                                                    ...
                                                    <input type="hidden" name="reciever" value="accountant-<?php echo $cont['admin_id'];?>">
                                                    <input id="disabled" disabled="disabled" class="tn oq kf kl kkh ka" type="text" value="<?php echo $cont['first_name'].' '.$cont['last_name'];?>"/>
                                                </div>
                                            </div>
                                            <div>  
