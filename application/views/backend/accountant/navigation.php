         ...
         <div>
            ...
            <ul class="im">
               ...
               <li class="me vg rounded-sm ib wj <?php if($page_name == 'panel') echo 'bg-slate-900';?>" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('dashboard-'))">
                  <a class="block ya xw ci wr wu" :class="page.startsWith('dashboard-') &amp;&amp; 'hover--text-slate-200'" href="<?php echo base_url();?>accountant/panel">
               ...
               <li class="me vg rounded-sm ib wj <?php if($page_name == 'messages') echo 'bg-slate-900';?>" :class="page === 'messages' &amp;&amp; 'bg-slate-900'">
               <a class="block ya xw ci wr wu" :class="page === 'messages' &amp;&amp; 'hover--text-slate-200'" href="<?php echo base_url();?>accountant/message">
                  <div class="flex items-center fg">
                     <div class="ad flex items-center">
                        <svg class="ap oo ur" viewBox="0 0 24 24">
                           <path class="db ys  <?php if($page_name == 'messages') echo 'text-indigo-500';?>" d="M14.5 7c4.695 0 8.5 3.184 8.5 7.111 0 1.597-.638 3.067-1.7 4.253V23l-4.108-2.148a10 10 0 01-2.692.37c-4.695 0-8.5-3.184-8.5-7.11C6 10.183 9.805 7 14.5 7z"></path>
                           <path class="db yu  <?php if($page_name == 'messages') echo 'text-indigo-300';?>" d="M11 1C5.477 1 1 4.582 1 9c0 1.797.75 3.45 2 4.785V19l4.833-2.416C8.829 16.85 9.892 17 11 17c5.523 0 10-3.582 10-8s-4.477-8-10-8z"></path>
                        </svg>
               ...
               <li class="me vg rounded-sm ib wj <?php if($page_name == 'admins' || $page_name == 'accountants' || $page_name == 'specialists') echo 'bg-slate-900';?>" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('users-'))">
                  ...
                  <div class="tec ttd 2xl:block">
                     <ul class="mf iu" :class="!open &amp;&amp; 'hidden'" x-cloak="">
                        ...
                        <li class="rx wj"> <a class="block yu hover--text-slate-200 wr wu ci" :class="page === 'accountants' &amp;&amp; '!text-indigo-500'" href="<?php echo base_url();?>accountant/accountants"> <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Contadores</span> </a> </li>
               ...
               <!--
                <li class="me vg rounded-sm ib wj <?php //if($page_name == 'clients') echo 'bg-slate-900';?>" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('finance-'))">
                  <a class="block ya xw ci wr wu" :class="page.startsWith('finance-') &amp;&amp; 'hover--text-slate-200'" href="<?php //echo base_url();?>accountant/clients">
                     <div class="flex items-center fg">
                        <div class="flex items-center">
                           <svg class="ap oo ur" viewBox="0 0 24 24">
               ...
               <li class="me vg rounded-sm ib wj <?php if($page_name == 'finance' || $page_name == 'payment') echo 'bg-slate-900';?>" x-data="{ open: false }" x-init="$nextTick(() => open = page.startsWith('finance-'))">
                  <a class="block ya xw ci wr wu" :class="page.startsWith('finance-') &amp;&amp; 'hover--text-slate-200'"href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                     <div class="flex items-center fg">
                        <div class="flex items-center">
                           <svg class="ap oo ur" viewBox="0 0 24 24">
                              <path class="db yu <?php if($page_name == 'finance' || $page_name == 'payment' ) echo 'text-indigo-300';?>" d="M13 6.068a6.035 6.035 0 0 1 4.932 4.933H24c-.486-5.846-5.154-10.515-11-11v6.067Z"></path>
                              <path class="db bo <?php if($page_name == 'finance' || $page_name == 'payment') echo 'text-indigo-500';?>" d="M18.007 13c-.474 2.833-2.919 5-5.864 5a5.888 5.888 0 0 1-3.694-1.304L4 20.731C6.131 22.752 8.992 24 12.143 24c6.232 0 11.35-4.851 11.857-11h-5.993Z"></path>
                              <path class="db ys <?php if($page_name == 'finance' || $page_name == 'payment') echo 'text-indigo-600';?>" d="M6.939 15.007A5.861 5.861 0 0 1 6 11.829c0-2.937 2.167-5.376 5-5.85V0C4.85.507 0 5.614 0 11.83c0 2.695.922 5.174 2.456 7.17l4.483-3.993Z"></path>
                           </svg>
                  ...
                  <div class="tec ttd 2xl:block">
                     <ul class="mf iu" :class="!open &amp;&amp; 'hidden'" x-cloak="">
                        <li class="rx wj"> <a class="block yu hover--text-slate-200 wr wu ci" :class="page === 'admins' &amp;&amp; '!text-indigo-500'" href="<?php echo base_url();?>accountant/finance"> <span class="text-sm gk ttl ttb 2xl:opacity--100 wf">Pagos</span> </a> </li>
