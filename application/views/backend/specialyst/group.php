                    ...
                    <div class="tv tk nv">
                            ...
                            <div class="oq flex items-center fg">
                                <div class="td" x-data="{ open: false }">
                                    ...
                                    <div class="am nv tp tq tb uz bg-white border border-slate-200 ms rounded by lq iu" @click.outside="open = false" @keydown.escape.window="open = false" x-show="open" x-transition:enter="wr wh wf fe" x-transition:enter-start="opacity-0 aw" x-transition:enter-end="bv ax" x-transition:leave="wr wh wf" x-transition:leave-start="bv" x-transition:leave-end="opacity-0" style="display: none;">
                                        <ul>                                  
                                            <li>
                                                <a class="gk text-sm ys xy block ms me" href="<?php echo base_url();?>specialyst/message" @click="open = false" @focus="open = true" @focusout="open = false"> 
                                            ...
                                            <li>
                                                <a class="gk text-sm ys xy block ms me" href="<?php echo base_url(); ?>specialyst/group" @click="open = false" @focus="open = true" @focusout="open = false"> 
                                                    <div class="flex items-center fg">
                                                        <div class="ad flex items-center ci">
                        ...
                        <div class="mn mr" id="bloqueA">
                                ...
                                <div class="ij ">
                                    ...
                                    ?>
                                            <a href="<?php echo base_url('specialyst/group/group_message_read/' . $row['group_message_thread_code']); ?>/">
    ...
    function delete_group(id){
        Swal.fire({
            ...
            if (resultado.value) {
                ...
                location.href ="<?php echo base_url();?>specialyst/group/delete_group/<?php echo $row['group_message_thread_code']; ?>/"+id;
            }
        })
    }
    </script>
